# Generated by Powerlevel10k configuration wizard on 2020-08-13 at 23:17 -05.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='arch_linux'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='rails|cd|pamac'
